--ACCOUNT
create or replace procedure Hasura.createAccount(nameN varchar(128),
...
create or replace procedure Hasura.deleteAccount(id_account int)
    language plpgsql
as
$$
declare
...
create or replace procedure Hasura.updateAccount(id_account int, nameN varchar(128),
first_nameN varchar(128),
last_nameN varchar(128),
passN varchar(64))
    language plpgsql
...
create or replace procedure Hasura.beginonline(id_account int, passwd varchar(128))
    language plpgsql
as
$$
declare
...
create or replace procedure Hasura.endonline(id_session int)
    language plpgsql
as
$$
declare
...
create or replace procedure Hasura.addnote(account_id int, textN varchar(256) , imgN bytea)
    language plpgsql
as
$$
declare
...
create or replace procedure Hasura.updatenote(id_accountn int,id_noten int, textN varchar(256),imgN bytea)
    language plpgsql
as
$$
declare
...
create or replace procedure Hasura.deletenote(id_accountn int,id_noten int)
    language plpgsql
as
$$
declare 
...
create or replace function Hasura.selectnote(id_accountn int)
...
create or replace function Hasura.selectMYnote(account_iDD int)
returns TABLE(account_id_D int,
privelege_D int,
text_D varchar(256),
img_D bytea,
...
create or replace procedure Hasura.sharenote(id_accountn int, id_dependet_user int, id_noten int, perms varchar(64))
    language plpgsql
as
$$
declare 
...
create or replace procedure Hasura.editshare(id_account int, id_dependet_user int, id_noteL int, perms varchar(64))
    language plpgsql
as
$$
declare 
